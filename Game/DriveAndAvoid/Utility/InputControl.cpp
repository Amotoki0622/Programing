...
void InputControl::Update()
{
	...
	trigger[0] = (float)input_state.LeftTrigger / (float)CHAR_MAX;
	trigger[1] = (float)input_state.RightTrigger / (float)CHAR_MAX;


	//左スティック入力値の更新 (-1.0～1.0に範囲を制限する)
